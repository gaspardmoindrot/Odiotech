...
>
  <head>
    ...
    />
    <meta charset="UTF-8" />
    <title>Profil utilisateur - Infinite Measure</title>
  </head>

  <body>
    <nav>
      <a class="logo" href="accueil_utilisateur.php"
        ><img src="../Image/infinite_measure_logo.png" alt="Logo" width="65px"
      /></a>
    ...
    <footer>
      <nav2>
        Site réalisé par&nbsp<a
          class="acceuilFooter"
          href="page_de_contact_utilisateur.php"
        >
          Odio'tech</a
        >
        <div class="navigation2">
          <a href="mentionlegales_utilisateur.php">Mentions légales</a>
          <a href="politiquedeconfidentialite_utilisateur.php"
